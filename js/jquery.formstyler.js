...
/* ANDB */ $('.jqselect').closest('div.input-wrap').css({'position':'relative', 'zIndex':10});
/* ANDB */ $(el).closest('div.input-wrap').css({'position':'relative', 'zIndex':110});
								...
								li.filter(':not(.disabled):not(.optgroup)').click(function() {
									...
									dropdown.hide();
                  $('.jqselect').closest('div.input-wrap').css({'position':'relative', 'zIndex':10});
									selectbox.removeClass('opened dropup dropdown');
									// колбек при закрытии селекта
									opt.onSelectClosed.call(selectbox);
